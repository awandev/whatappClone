export default [{
    ...
    users: [{
        id: 'u1',
        name: 'Vadim',
        imageUri: 'https://randomuser.me/api/portraits/men/47.jpg',
    }, {
        id: 'u2',
        name: 'Lukas',
        imageUri: 'https://randomuser.me/api/portraits/men/64.jpg',
    }],
    lastMessage: {
        id: 'm1',
    ...
    users: [{
        ...
        id: 'u3',
        name: 'Daniil',
        imageUri: 'https://randomuser.me/api/portraits/men/49.jpg',
    }],
    lastMessage: {
        id: 'm2',
    ...
    users: [{
        ...
        id: 'u5',
        name: 'Vlad',
        imageUri: 'https://randomuser.me/api/portraits/men/81.jpg',
    }],
    lastMessage: {
        id: 'm4',
    ...
    users: [{
        id: 'u1',
        name: 'Vadim',
        imageUri: 'https://randomuser.me/api/portraits/men/82.jpg',
    }, {
        id: 'u6',
        name: 'Elon Musk',
        imageUri: 'https://randomuser.me/api/portraits/men/83.jpg',
    }],
    lastMessage: {
        id: 'm5',
    ...
    users: [{
        id: 'u1',
        name: 'Vadim',
        imageUri: 'https://randomuser.me/api/portraits/men/84.jpg',
    }, {
        id: 'u7',
        name: 'Adrian',
        imageUri: 'https://randomuser.me/api/portraits/men/85.jpg',
    }],
    lastMessage: {
        id: 'm6',
    ...
    users: [{
        id: 'u1',
        name: 'Vadim',
        imageUri: 'https://randomuser.me/api/portraits/men/86.jpg',
    }, {
        id: 'u8',
        name: 'Borja',
        imageUri: 'https://randomuser.me/api/portraits/men/87.jpg',
    }],
    lastMessage: {
        id: 'm7',
        content: 'How are you doing?',
    ...
    users: [{
        id: 'u1',
        name: 'Vadim',
        imageUri: 'https://randomuser.me/api/portraits/men/88.jpg',
    }, {
        id: 'u9',
        name: 'Mom',
    ...
    users: [{
        id: 'u1',
        name: 'Vadim',
        imageUri: 'https://randomuser.me/api/portraits/men/89.jpg',
    }, {
        id: 'u10',
        name: 'Angelina Jolie',
